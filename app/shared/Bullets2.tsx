...
const Bullets = () => {
    ...
    const shotSound = typeof window !== 'undefined' ? new Audio("/shot.mp3") : null;
    const missSound = typeof window !== 'undefined' ? new Audio("/misfire.mp3") : null;
    const chamberSound = typeof window !== 'undefined' ? new Audio("/chamber.mp3") : null;
